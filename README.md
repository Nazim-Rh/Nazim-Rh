...
<ul>
  <li>
    <img src="assets/N-Light.png" width="80" align="left">
    <h4>N-Light</h4>
    <p>An interactive GUI that wraps AstroSat LAXPC (Format-B) data reduction and light curve inspection — drives laxpcsoft and HEASoft's <code>lcurve</code> to produce a combined lightcurve plus per-GTI plots. Built with Python (PyQt5).</p>
    <br clear="left">
  </li>
  <li>
